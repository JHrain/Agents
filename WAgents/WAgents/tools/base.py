...
class AutoGeneratedTool(Tool):
    ...
    def _parse_parameters(self) -> List[ToolParameter]:
        ...
        # 从docstring解析参数
        param_description = self._parse_param_description(docstring)
        ...
        for param_name, param in sig.parameters.items():
            ...
            # 获取描述
            description = param_description.get(param_name, f"参数 {param_name}")
    ...
    def _parse_param_description(self, docstring: str) -> Dict[str, str]:
        """从 docstring 解析参数描述
